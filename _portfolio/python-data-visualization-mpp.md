...
## 项目背景
本项目针对肺炎支原体流行期间：2023年10-12月，在首都医科大学附属首都儿童医学中心被诊断为肺炎支原体肺炎患者数据集，依据儿童肺炎支原体肺炎诊疗指南 (2023年版) 中轻重症诊断标准将患儿分为重症肺炎支原体肺炎患儿与轻症肺炎支原体肺炎患儿。通过Python数据可视化技术完成探索性数据分析（EDA）与模型性能评估，旨在挖掘患者年龄、实验室指标与肺炎轻重的关联规律，为临床预后预测提供数据支撑。项目核心目标包括掌握统计图表绘制方法、为不同分析场景选择合适可视化方案，以及提升代码复用效率。
